        ...
        return (React.createElement(facet_1.default, null,
            React.createElement(facet_header_1.default, Object.assign({}, this.props),
                React.createElement("div", { style: { textAlign: 'right' } },
                    React.createElement(button_1.FacetMenuButton, { onClick: () => this.setState({ collapsed: !this.state.collapsed, options: false }) },
                    ...
                    React.createElement(button_1.FacetMenuButton, { onClick: () => this.setState({ options: !this.state.options, collapsed: false }) },
            ...
            this.state.options &&
                React.createElement(options_1.default, Object.assign({}, this.props)),
            React.createElement(values_1.default, { collapsed: this.state.collapsed, facet: this.props.state.facetsManager.getListFacet(this.props.field), field: this.props.field, state: this.props.state })));
    }
}
