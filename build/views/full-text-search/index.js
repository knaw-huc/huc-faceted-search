...
class FullTextSearch extends React.PureComponent {
    constructor() {
        ...
        this.requestAddQuery = lodash_debounce_1.default(this._addQuery, 1000);
    }
    render() {
        return (React.createElement(exports.Wrapper, null,
            ...
            React.createElement("div", { id: "loader", ref: this.loaderRef })));
    }
    showLoader() {
        clearInterval(this.loaderIntervalID);
        this.loaderIntervalProgress = 0;
        this.loaderIntervalID = setInterval(() => {
            this.loaderIntervalProgress += 25;
            const perc = this.loaderIntervalProgress / 1000;
            this.loaderRef.current.style.width = `${perc * 100}%`;
        }, 25);
    }
    hideLoader() {
        clearInterval(this.loaderIntervalID);
        this.loaderIntervalProgress = 0;
        this.loaderRef.current.style.width = '0';
    }
}
