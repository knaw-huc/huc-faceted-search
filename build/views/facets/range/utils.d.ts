export declare function getEndDate(timestamp: number, interval: string): number;
...
export declare function formatDate(facetData: RangeFacetData, num: number, sameYear?: boolean): number | string;
